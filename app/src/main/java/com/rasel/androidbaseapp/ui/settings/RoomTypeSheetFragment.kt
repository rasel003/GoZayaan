...
import com.rasel.androidbaseapp.databinding.FragmentRoomTypeSheetBinding
import com.rasel.androidbaseapp.ui.lessons.LessonAdapter
 ...
 */
class RoomTypeSheetFragment : Fragment() {

    private lateinit var binding: FragmentRoomTypeSheetBinding

    private val onClick: (Int) -> Unit = { step ->
        val course = this.course
        if (course != null) {
            binding.lessonsSheet.postDelayed(300L) {
                /*val action = LessonsSheetFragmentDirections.actionLessonsSheetToLesson(course.id, step)
    ...
    override fun onCreateView(
        ...
        binding = FragmentRoomTypeSheetBinding.inflate(inflater, container, false).apply {
