...
package com.rasel.androidbaseapp.ui.compose
...
import com.rasel.androidbaseapp.data.models.Account
import com.rasel.androidbaseapp.data.models.AccountStore
import com.rasel.androidbaseapp.data.models.Email
import com.rasel.androidbaseapp.data.models.EmailStore
import com.rasel.androidbaseapp.databinding.ComposeRecipientChipBinding
import com.rasel.androidbaseapp.databinding.FragmentComposeBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        binding.run {
            ...
            returnTransition = Slide().apply {
                duration = resources.getInteger(R.integer.app_motion_duration_medium).toLong()
