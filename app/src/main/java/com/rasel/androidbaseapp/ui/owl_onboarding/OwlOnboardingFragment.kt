...
package com.rasel.androidbaseapp.ui.owl_onboarding
...
import com.rasel.androidbaseapp.databinding.FragmentOwlOnboardingBinding
import com.rasel.androidbaseapp.util.spring

/**
 * Onboarding [Fragment] which displays a list of Topics for a user to select.
 */
class OwlOnboardingFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val binding = FragmentOwlOnboardingBinding.inflate(inflater, container, false).apply {
            fab.setOnClickListener {
                findNavController().navigate(R.id.action_owl_onboarding_to_featured)
            }
             imgSearch.setOnClickListener {
                findNavController().navigate(R.id.action_owl_onboarding_to_search)
            }
            imgSetting.setOnClickListener {
                findNavController().navigate(R.id.action_owl_onboarding_to_myCourses)
            }
            topicGrid.apply {
