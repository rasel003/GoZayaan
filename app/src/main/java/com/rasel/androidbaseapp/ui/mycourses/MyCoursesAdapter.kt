...
import com.rasel.androidbaseapp.databinding.CourseItemBinding
import com.rasel.androidbaseapp.util.ShapeAppearanceTransformation
...
class MyCoursesAdapter : ListAdapter<Course, MyCourseViewHolder>(CourseDiff) {
    ...
    private val shapeTransform =
        ShapeAppearanceTransformation(R.style.ShapeAppearance_App_SmallComponent)
