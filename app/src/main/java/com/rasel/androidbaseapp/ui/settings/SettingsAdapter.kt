...
class SettingsAdapter @Inject constructor() : BaseAdapter<Settings>() {
    ...
    override fun getViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val binding = ItemSettingListBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    inner class SettingsViewHolder(
        ...
        private fun setRadius(cardView: MaterialCardView, isTop: Boolean) {
            val radius: Float = cardView.context.resources.getDimension(R.dimen.card_corner_radius)
