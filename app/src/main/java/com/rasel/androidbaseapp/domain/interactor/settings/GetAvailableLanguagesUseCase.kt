...
) : UseCase<Unit, List<Languages>>(dispatcher) {

    override suspend fun execute(parameters: Unit): List<Languages> = listOf(Languages.ENGLISH, Languages.BURMESE, Languages.CHINESE)
}
